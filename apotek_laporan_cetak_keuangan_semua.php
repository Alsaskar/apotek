...
$query = $connect->prepare("SELECT penjualan.*, penjualan_item.*, obat.* FROM penjualan, penjualan_item, obat WHERE penjualan.no_penjualan = penjualan_item.no_penjualan AND penjualan_item.kd_obat = obat.kode_obat");
$query->execute();
